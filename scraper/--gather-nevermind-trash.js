...
async function gather(options, cb) {
	...
	async function _tryScrape(obj) {
		...
		const result = await page.evaluate(_ => {
			...
			// let ids = Array.from(document.querySelectorAll('a.css-4rbku5.css-18t94o4.css-901oao.r-1re7ezh.r-1loqt21.r-1q142lx.r-1qd0xha.r-a023e6.r-16dba41.r-ad9z0x.r-bcqeeo.r-3s2u2q.r-qvutc0')).map(a => a.getAttribute('name').match(/\d+$/)[0]);
			// let ids = document.querySelectorAll('a.css-4rbku5.css-18t94o4.css-901oao.r-1re7ezh.r-1loqt21.r-1q142lx.r-1qd0xha.r-a023e6.r-16dba41.r-ad9z0x.r-bcqeeo.r-3s2u2q.r-qvutc0');
